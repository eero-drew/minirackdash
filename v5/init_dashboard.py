...
class EeroAPI:
    ...
    def get_headers(self):
        headers={{'Content-Type':'application/json','User-Agent':'Eero-Dashboard/5.1.2'}}
...
if __name__=='__main__':
    logging.info("Starting Eero Dashboard Backend v5.1.2")
...
def create_service():
    ...
    svc=f"""[Unit]
Description=Eero Dashboard v5.1.2
...
def main():
    os.system('clear')
    print_header(f"Eero Dashboard v5.1.2 Installer - v{SCRIPT_VERSION}")
